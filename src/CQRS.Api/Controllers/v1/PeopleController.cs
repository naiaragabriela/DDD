...
namespace CQRS.Api.Controllers.v1
{
    ...
    public class PeopleController : ControllerBase
    {
        ...
        {
            var response = await _getPersonQueryHandler.HandleAsync(
        ...
        public async Task<IActionResult> GetAsync(
            ...
            CancellationToken cancellationToken)
        {
            var response = await _listPersonQueryHandler.HandleAsync(
        ...
        public async Task<IActionResult> InsertAsync(
            ...
            CancellationToken cancellationToken)
        {
            var response = await _createPersonCommandHandler.HandleAsync(
        ...
        public async Task<IActionResult> DeleteByIdAsync(
            ...
            CancellationToken cancellationToken)
        {
            await _deletePersonCommandHandler.HandleAsync(
